...
import icon from '../../assets/images/icon/ethe.svg'
                                    ...
                                    <div className="slider-item">
                                                <div className="sc-product style1 collection">
                                                    ...
                                                    <div className="tf-author">
                                                        ...
                                                        <div className="details-item">{idx.count}</div>
                                                    </div>
                                                    <div className="top">
                                                        <div className="content">
                                                            <div className="details"><span><img src={icon} alt="images" /></span> <Link to="#">{idx.price}</Link> </div>
                                                            <div className="price">{idx.pricesale}</div>
                                                        </div>
