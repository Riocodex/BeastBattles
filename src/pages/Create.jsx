                        ...
                        <div className="col-xl-9 col-lg-8 ">
                            <div className="add-nft-inner">
                                ...
                                <ul className="blockchain-button">
                                    <li><Link to="#"><img src={icon1} alt="Binasea" />MetaMask</Link></li>
                                    <li><Link to="#"><img src={icon2} alt="Binasea" />Coinbase</Link></li>
                                    <li><Link to="#"><img src={icon3} alt="Binasea" />Torus</Link></li>
                                    <li><Link to="#"><img src={icon4} alt="Binasea" />Fortmatic</Link></li>
                                    <li><Link to="#">Show more options</Link></li>
                                </ul>
                                ...
                                <div className="bottom">
                                    <div className="details-product">
                                        ...
                                        <div className="current-bid">
                                            ...
                                            <div className="price">
                                                <span className="cash">5 ETH</span><span className="icon"><img src={ico3} alt="images" /></span>
                                            </div>
                                        </div>
                                    </div>
